         ...
         <div className="max-w-7xl mx-auto px-6">
            <div className="bg-linen grid md:grid-cols-2 overflow-hidden border border-linen">
                ...
                <div className="relative min-h-[400px]">
                    <img src="https://images.unsplash.com/photo-1594489428504-5c0c480a15fd?auto=format&fit=crop&q=80&w=1200" className="absolute inset-0 w-full h-full object-cover" alt="Farmer in Kastoria" />
                </div>
            </div>
         </div>
      </section>
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-20">
                ...
                <div>
                    ...
                    <ul className="text-sm text-gray-500 space-y-4">
                        <li><a href="#" className="hover:text-kastoria-blue transition-colors">Η Ιστορία μας</a></li>
